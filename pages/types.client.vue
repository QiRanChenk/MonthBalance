<template>
  <div class="p-2 md:p-4 min-h-full">
    ...
    >
      <div
        class="fixed right-0 top-0 h-full w-full max-w-md bg-white dark:bg-[#151a18] shadow-xl transform transition-transform duration-300 p-2 md:p-4 overflow-y-auto"
        @click.stop
      >
    ...
    >
      <div
        class="bg-white dark:bg-[#151a18] rounded-lg shadow-xl w-full max-w-md transform transition-all"
        @click.stop
      >
        <!-- 对话框标题 -->
