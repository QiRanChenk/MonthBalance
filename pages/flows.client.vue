<template>
  <div class="p-2 md:p-4 min-h-full space-y-2">
    ...
    >
      <div
        class="bg-white dark:bg-[#151a18] rounded-lg shadow-xl w-full max-w-6xl max-h-[90vh] flex flex-col"
        @click.stop
      >
        <div
    ...
    >
      <div
        class="bg-white dark:bg-[#151a18] rounded-lg shadow-xl w-full max-w-md flex flex-col"
        @click.stop
      >
