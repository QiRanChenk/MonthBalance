  ...
  <div class="p-0 md:p-4">
    ...
    <div class="max-w-7xl mx-auto">
      ...
      >
        <!-- Income Card -->
        <div
          class="bg-white dark:bg-white/[0.04] rounded-2xl shadow-sm p-2.5 md:p-4 border border-black/5 dark:border-white/[0.06] cursor-pointer transition-colors hover:bg-emerald-50/50 dark:hover:bg-white/[0.06]"
          @click="clickDay('', '收入')"
        >
          <div class="flex items-center flex-row space-x-2">
            <div class="flex-shrink-0 mb-0 hidden md:block">
              <div
                class="w-10 h-10 bg-emerald-500/10 rounded-full flex items-center justify-center"
              >
                <ArrowTrendingUpIcon class="w-5 h-5 text-emerald-500" />
              </div>
            </div>
            <div class="md:ml-2 text-center md:text-left min-w-0">
              <p class="text-[11px] md:text-xs text-slate-500 dark:text-slate-400">
                总收入
              </p>
              <p
                class="text-sm md:text-2xl font-semibold tabular-nums tracking-tight text-emerald-600 dark:text-emerald-400 truncate"
              >
        ...
        <!-- Expense Card -->
        <div
          class="bg-white dark:bg-white/[0.04] rounded-2xl shadow-sm p-2.5 md:p-4 border border-black/5 dark:border-white/[0.06] cursor-pointer transition-colors hover:bg-rose-50/50 dark:hover:bg-white/[0.06]"
          @click="clickDay('', '支出')"
        >
          <div class="flex items-center flex-row space-x-2">
            <div class="flex-shrink-0 mb-0 hidden md:block">
              <div
                class="w-10 h-10 bg-rose-500/10 rounded-full flex items-center justify-center"
              >
            ...
            <div class="md:ml-2 text-center md:text-left min-w-0">
              ...
              <p
                class="text-sm md:text-2xl font-semibold tabular-nums tracking-tight text-rose-600 dark:text-rose-400 truncate"
              >
        ...
        <!-- Balance Card -->
        <div
          class="bg-white dark:bg-white/[0.04] rounded-2xl shadow-sm p-2.5 md:p-4 border border-black/5 dark:border-white/[0.06]"
        >
          <div class="flex items-center flex-row space-x-2">
            <div class="flex-shrink-0 mb-0 hidden md:block">
              <div
                class="w-10 h-10 bg-slate-500/10 rounded-full flex items-center justify-center"
              >
            ...
            <div class="md:ml-2 text-center md:text-left min-w-0">
              ...
              <p
                class="text-sm md:text-2xl font-semibold tabular-nums tracking-tight truncate"
                :class="
                  balance >= 0
      ...
      <!-- Calendar -->
      <div
        class="bg-white dark:bg-white/[0.04] border border-black/5 dark:border-white/[0.06] w-full overflow-hidden rounded-2xl shadow-sm"
      >
        <!-- Desktop Calendar -->
