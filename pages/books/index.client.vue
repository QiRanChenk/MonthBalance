...
<template>
  <div class="p-2 md:p-4 min-h-full">
    <!-- 搜索和操作栏 -->
    <div
      class="bg-white dark:bg-[#151a18] rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-2 mb-2 md:mb-4"
    >
      <!-- 宽屏：左右布局，窄屏：分两行 -->
    ...
    <!-- 数据表格容器 -->
    <div
      class="bg-white dark:bg-[#151a18] shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden"
    >
      <!-- 加载状态 -->
      ...
      >
        <div
          v-for="item in tabledata.data"
          :key="item.id"
          class="bg-gray-50 dark:bg-[#151a18] p-3 space-y-2 border-b border-gray-200 dark:border-gray-700 last:border-b-0"
        >
          <!-- 标题行：账本名称 + 删除按钮 -->
                ...
                <button
                  ...
                  :class="[
                    ...
                    page === pageQuery.pageNum
                      ...
                      : 'border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 bg-white dark:bg-[#151a18] text-green-950 dark:text-white',
                  ]"
                >
                  {{ page }}
                </button>
