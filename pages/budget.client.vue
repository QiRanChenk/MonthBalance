<template>
  <div class="p-2 md:p-4 min-h-full">
    <!-- 月份选择和操作栏 -->
    <div
      class="bg-white dark:bg-[#151a18] rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-3 mb-3"
    >
    ...
    <div v-if="budgetDialog" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div class="bg-white dark:bg-[#151a18] rounded-lg shadow-xl max-w-md w-full">
    ...
    <div v-if="fixedFlowDialog" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div class="bg-white dark:bg-[#151a18] rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
    ...
    <div v-if="confirmDeleteDialog" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div class="bg-white dark:bg-[#151a18] rounded-lg shadow-xl max-w-sm w-full">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
