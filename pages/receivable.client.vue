<template>
  <div class="p-2 md:p-4 min-h-full">
    ...
    >
      <div
        class="bg-white dark:bg-[#151a18] rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto"
      >
    ...
    >
      <div
        class="bg-white dark:bg-[#151a18] rounded-lg shadow-xl max-w-md w-full"
      >
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          <h3 class="text-lg font-semibold text-green-950 dark:text-white">
            确认收款
    ...
    >
      <div
        class="bg-white dark:bg-[#151a18] rounded-lg shadow-xl max-w-sm w-full"
      >
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
