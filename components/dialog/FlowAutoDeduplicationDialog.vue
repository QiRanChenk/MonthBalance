...
<template>
  ...
  >
    <div
      class="bg-white dark:bg-[#151a18] rounded-lg shadow-xl w-full max-w-7xl max-h-[95vh] flex flex-col transform transition-all"
      @click.stop
    >
      <!-- 标题栏 -->
      <div
      ...
      <div class="flex-1 overflow-hidden">
        ...
        >
          <div
            ...
            :key="groupIndex"
            class="bg-white dark:bg-[#151a18] border border-gray-200 dark:border-gray-600 rounded-lg overflow-hidden"
          >
            <!-- 组标题 -->
            <div
