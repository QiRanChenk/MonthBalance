<template>
  <!-- 自定义流水导入对话框 -->
  <div
    class="bg-white dark:bg-[#151a18] rounded-lg shadow-xl w-full max-w-6xl mx-auto max-h-[90vh] overflow-y-auto"
  >
    <!-- 标题栏 -->
    <div
      ...
      <div v-if="tab === 2" class="space-y-4">
        ...
        >
          <div
            ...
            :key="field"
            class="mb-4 p-3 bg-white dark:bg-[#151a18] rounded border"
          >
        ...
        >
          <div class="excel-table">
            <table ref="excelTable" class="min-w-full">
              ...
              <tbody
                ref="excelTableBody"
                class="bg-white dark:bg-[#151a18] divide-y divide-gray-200 dark:divide-gray-700"
              ></tbody>
            </table>
          </div>
        </div>
  ...
  >
    <div
      class="bg-white dark:bg-[#151a18] rounded-lg shadow-xl w-full max-w-7xl mx-auto max-h-[90vh] overflow-y-auto"
      @click.stop
    >
      <!-- 标题栏 -->
      <div
