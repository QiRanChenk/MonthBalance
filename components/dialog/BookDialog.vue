<template>
  ...
  <Teleport to="body">
    ...
    >
      <div
        @click.stop
        class="bg-white dark:bg-[#151a18] rounded-lg shadow-xl w-full max-w-2xl max-h-[80vh] flex flex-col"
      >
        <!-- Header -->
        <div
  ...
  <Teleport to="body">
    ...
    >
      <div
        @click.stop
        class="bg-white dark:bg-[#151a18] rounded-lg shadow-xl w-full max-w-md"
      >
        <!-- Header -->
