<template>
  ...
  >
    <div
      class="bg-white dark:bg-[#151a18] rounded-lg shadow-xl w-full max-w-2xl mx-auto max-h-[90vh] overflow-y-auto"
      @click.stop
    >
      <!-- 标题栏 -->
      <div
  ...
  >
    <div
      class="bg-white dark:bg-[#151a18] rounded-lg shadow-xl w-full max-w-md mx-auto"
      @click.stop
    >
      <!-- 标题栏 -->
      <div
