<template>
  <div class="chart-common-container">
    ...
    >
      <div
        class="w-80 h-full bg-white dark:bg-[#151a18] shadow-xl border-l border-gray-200 dark:border-gray-700 p-2 md:p-4 overflow-y-auto"
        @click.stop
      >
  ...
  >
    <div
      class="w-full max-w-6xl max-h-[90vh] bg-white dark:bg-[#151a18] rounded-lg shadow-xl overflow-hidden"
      @click.stop
    >
      <div
