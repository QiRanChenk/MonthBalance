...
<template>
  <header
    class="bg-white dark:bg-[#101513] border-b border-black/5 dark:border-white/[0.06]"
  >
      ...
      <div class="flex justify-between h-12 md:h-16">
        ...
        <div class="flex items-center">
          ...
          <button
            ...
            class="p-2 rounded-md text-slate-600 dark:text-slate-300 hover:bg-black/5 dark:hover:bg-white/5 transition-colors"
          >
          ...
          <div class="items-center ml-2 md:ml-0 hidden sm:flex">
            ...
            <span
              class="ml-2 text-xl font-bold tracking-tight text-emerald-600 dark:text-emerald-400"
            >
              Cashbook
            </span>
          </div>
        ...
        <div class="flex items-center flex-1 justify-center">
          <div class="flex items-center space-x-2 md:space-x-4">
            ...
            <button
              ...
              class="px-2 py-1 md:px-3 md:py-1.5 rounded-lg border border-black/10 dark:border-white/10 text-slate-600 dark:text-slate-300 hover:bg-black/5 dark:hover:bg-white/5 transition-colors text-xs font-medium"
            >
              切换账本
            </button>
          </div>
        ...
        <div class="relative flex items-center">
          ...
          <Teleport to="body">
            ...
            >
              <div
                @click.stop
                class="absolute right-4 top-16 mt-2 w-48 bg-white dark:bg-[#151a18] rounded-md shadow-lg border border-black/5 dark:border-white/10 z-50"
              >
                <div class="py-1">
                  <button
