<template>
  <div class="bg-white dark:bg-[#151a18] rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
    <!-- 表格容器 -->
        ...
        <div class="flex gap-3 items-center">
          ...
          <div class="flex items-center gap-2">
            ...
            <input
              ...
              type="text"
              placeholder="可选"
              class="w-32 px-2 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-[#151a18] text-green-950 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
